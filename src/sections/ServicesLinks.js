    ...
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      >
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-bold text-xl text-gray-900">Corporate Limo Service</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-bold text-xl text-gray-900">Airport || Seaport Transfer</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-bold text-xl text-gray-900">Special Occassion Limo Service</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-bold tex-xl text-gray-900">Events & Tours Limo Service</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-bold text-xl text-gray-900">Party Limo Service</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-bold text-xl text-gray-900">Long Distance Limo & Car Service</p>
